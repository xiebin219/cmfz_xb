                ...
                <div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true" align="center">
                    ...
                    <div class="panel panel-success">
                        ...
                        <div id="collapseTwo" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingTwo">
                            <div class="panel-body">
                                <ul class="nav nav-pills nav-stacked">
                                    <li><button class="btn btn-success">用户展示</button></li><br>
                                    <li><button class="btn btn-success">用户统计</button></li><br>
                    ...
                    <div class="panel panel-warning">
                        ...
                        <div id="collapseThree" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingThree">
                            <div class="panel-body">
                                <ul class="nav nav-pills nav-stacked">
                                    <li><button class="btn btn-warning">专辑展示</button></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="panel panel-danger">
                        ...
                        <div id="collapseFour" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingFour">
                            <div class="panel-body">
                                <ul class="nav nav-pills nav-stacked">
                                    <li><button class="btn btn-danger">文章展示</button></li>
                                </ul>
                            </div>
                        </div>
                    </div>
